...
# Form implementation generated from reading ui file 'consultar_horariotest.ui'
#
...
class Ui_ConsultarHorario(object):
    ...
    def retranslateUi(self, ConsultarHorario):
        ...
        item.setText(_translate("ConsultarHorario", "Ej2"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("ConsultarHorario", "Ej3"))
        item = self.tableWidget.item(0, 3)
        item.setText(_translate("ConsultarHorario", "Ej4"))
