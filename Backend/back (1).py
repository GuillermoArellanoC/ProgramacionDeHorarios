...
def cargar_clases_desde_csv():
    with open("C:/Users/Zuri_/Downloads/Libro1.csv", newline='', encoding='utf-8') as archivo_csv:
...
# Función para añadir materia manualmente
def añadir_materia_manualmente():
    salon = input("Ingrese el nombre del salón: ")
...
while True:
    ...
    print("5. Añadir Materia Manualmente")
    print("6. Editar materia")
    print("7. Salir")
